...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 172.0, 74.5, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 480.0, 137.0, 53.0, 22.0 ],
					"style" : "",
					"text" : "print kl2",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 480.0, 105.0, 80.0, 22.0 ],
					"style" : "",
					"text" : "keylink"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 337.5, 400.0, 87.0 ],
					"style" : "",
					"text" : "# In Max/MSP:\n[keylink] → [udpsend 239.255.0.1 7474]\n[udpreceive 7474] → [keylink]\n[tosymbol {\"type\":\"set-state\",\"state\":{\"key\":\"G\",\"mode\":\"Mixolydian\",\"tempo\":140}}] → [keylink]"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 237.0, 165.0, 24.0, 24.0 ],
					"style" : ""
				}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 120.0, 133.0, 50.0, 22.0 ],
									"style" : "",
									"text" : "stop"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 79.0, 215.0, 30.0, 30.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 118.0, 83.5, 44.0, 15.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 59.0, 245.0, 400.0, 20.0 ],
					"style" : "",
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 59.5, 233.0, 30.5, 233.0, 30.5, 66.0, 59.5, 66.0 ],
					"source" : [ "obj-15", 0 ]
				}
